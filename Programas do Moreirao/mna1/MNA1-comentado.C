...
/*matriz variavel global, vai preenchendo a estampa com isso */
...
int main(void)
{
 ...
 denovo:
  ...
  while (fgets(txt,MAX_LINHA,arquivo)) {
    ...
    /*transforma o primeiro caractere do texto em letra maiuscula,
